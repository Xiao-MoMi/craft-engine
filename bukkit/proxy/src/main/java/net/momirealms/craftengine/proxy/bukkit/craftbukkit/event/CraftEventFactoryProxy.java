...
public interface CraftEventFactoryProxy {
    ...
    Object callInventoryOpenEvent(@Type(clazz = ServerPlayerProxy.class) Object player,
    ...
    boolean handleBlockGrowEvent(@Type(clazz = LevelProxy.class) Object level,
    ...
    boolean handleBlockFormEvent(@Type(clazz = LevelProxy.class) Object level,
                                 @Type(clazz = BlockPosProxy.class) Object pos,
                                 @Type(clazz = BlockStateProxy.class) Object state,
                                 int flags);
}
