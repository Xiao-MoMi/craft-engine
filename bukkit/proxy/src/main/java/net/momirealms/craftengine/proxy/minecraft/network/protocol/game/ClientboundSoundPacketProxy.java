...
public interface ClientboundSoundPacketProxy {
    ClientboundSoundPacketProxy INSTANCE = ASMProxyFactory.create(ClientboundSoundPacketProxy.class);

    @ConstructorInvoker
    Object newInstance(@Type(clazz = HolderProxy.class) Object sound, @Type(clazz = SoundSourceProxy.class) Object source, double x, double y, double z, float volume, float pitch, long seed);
}
