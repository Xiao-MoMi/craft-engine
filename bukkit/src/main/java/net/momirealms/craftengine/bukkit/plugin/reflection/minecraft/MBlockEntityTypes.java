...
public final class MBlockEntityTypes {
    ...
    private static Object getById(String path) {
        ...
        return RegistryUtils.getRegistryValue(MBuiltInRegistries.BLOCK_ENTITY_TYPE, id);
    }

    private static int getRegistryId(Object type) {
        if (type == null) return -1;
        return RegistryProxy.INSTANCE.getId$0(MBuiltInRegistries.BLOCK_ENTITY_TYPE, type);
    }
}
