...
public class AvatarData<T> extends LivingEntityData<T> {
    ...
    // 1.21.11
    public static final AvatarData<Object> PLAYER_MAIN_HAND_V1_21_11 = of(AvatarData.class, EntityDataValue.Serializers$HUMANOID_ARM, HumanoidArmProxy.RIGHT, VersionHelper.isOrAbove1_21_11());
